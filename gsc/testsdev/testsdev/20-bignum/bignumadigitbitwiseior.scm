...
(println (##bignum.mdigit-ref (##bignum.adigit-bitwise-ior! c 0 a 0) 0))
(println (##bignum.mdigit-ref c 0))

(println (##bignum.mdigit-ref c 0))
(println (##bignum.mdigit-ref (##bignum.adigit-bitwise-ior! c 0 d 0) 0))
(println (##bignum.mdigit-ref c 0))

(println (##bignum.mdigit-ref a 0))
(##bignum.adigit-bitwise-ior! a 0 b 0)
(println (##fx= (##bignum.mdigit-ref b 0) (##bignum.mdigit-ref a 0)))

(println (##bignum.mdigit-ref d 0))
(println (##bignum.mdigit-ref (##bignum.adigit-bitwise-ior! d 0 d 0) 0))
(println (##bignum.mdigit-ref d 0))
